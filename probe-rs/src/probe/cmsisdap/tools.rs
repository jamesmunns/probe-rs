...
use crate::probe::{
    cmsisdap::CmsisDapFactory, DebugProbeInfo, DebugProbeSelector, ProbeCreationError, ProbeFactory,
};
use hidapi::HidApi;
use nusb::{
...
pub async fn open_device_from_selector(
    ...
    let hid_api = HidApi::new().await.map_err(ProbeCreationError::HidApi)?;
